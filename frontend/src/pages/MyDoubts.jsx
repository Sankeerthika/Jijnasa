...
import { StatusBadge, AppBadge } from '../components/ui-components';
import {
  MessageCircle,
  Plus,
  Search,
  ...
  useEffect(() => {
    const fetchMyDoubts = async () => {
      try {
        ...
        setDoubts(userDoubts.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp)));
      } catch (err) {
        ...
        <div className="p-6">
          {filteredDoubts.length > 0 ? (
            ...
            <div className="py-20 text-center">
              ...
              <p className="text-gray-500 font-medium mb-6">You haven't asked any doubts yet.</p>
              <button 
                onClick={() => navigate('/post-doubt')} 
